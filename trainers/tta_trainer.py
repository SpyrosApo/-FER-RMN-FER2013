...
def loss_graph(_train_loss_list,_val_loss_list):
    plt.plot(_train_loss_list, 'g', label='Training loss')
    plt.plot(_val_loss_list, 'b', label='validation loss')
...
def accu_graph(_train_acc_list,_val_acc_list):
    plt.plot(_train_acc_list, 'g', label='Training accuracy')
    plt.plot(_val_acc_list, 'b', label='validation accuracy')
    ...
    def train(self):
        ...
        try:
            while not self._is_stop():
                ...
                self._logging()
            loss_graph(self._train_loss_list,self._val_loss_list)
            accu_graph(self._train_acc_list,self._val_acc_list)
