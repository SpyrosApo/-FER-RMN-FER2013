...
#checkpoint_name = "pre_trained_resmasking_dropout1_rot30_2019Nov17_14.33"
checkpoint_name = 'my_resmasking_dropout1_test_2022Apr30_18.07'
...
def main():
    ...
    plt.savefig("./cm/cm_{}.pdf".format(checkpoint_name))
    plt.close()
    print("save at ./cm/cm_{}.pdf".format(checkpoint_name))
